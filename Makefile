...
build:
	valac src/news.vala src/widgets.vala src/NewsHeaderBar.vala src/NewsList.vala src/NewsParse.vala src/NewsPanel.vala --pkg gtk+-3.0 --pkg granite --pkg libxml-2.0 --pkg webkit2gtk-4.0 -o com.github.allen-b1.news
